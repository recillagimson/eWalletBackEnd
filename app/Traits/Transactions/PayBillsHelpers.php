...
trait PayBillsHelpers
{
    ...
    private function catchBayadErrors($errorDetails, $billerCode,UserAccount $user)
    {
        ...
        if ($errorCode == 34 && $errorMsg == "Please provide the correct Due Date.") return $this->correctDueDate($errorMsg);
        if ($errorCode == 34 && $errorMsg == "Please provide the correct Region.") return $this->correctRegion($errorMsg);
