...
class DRCRReportSupervisor implements WithHeadings, FromView, WithEvents
{
    private $fileName;
    private $from;
    private $to;
    ...
    public function __construct(Collection $data, string $from, $to, $type)
    {
        ...
        $this->to = $to;
        $this->type = $type;
        $this->records = $this->processDataSuperVisor($this->data);
    ...
    {
        return view('reports.log_histories.log_histories_supervisor', [
