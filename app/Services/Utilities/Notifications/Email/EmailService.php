...
class EmailService implements IEmailService
{
    ...
    public function sendSend2BankSenderNotification(
        string $to,
        string $refNo,
        string $accountNo,
        float $amount,
        ...
        $template = new SenderNotification(
            $hideAccountNo,
            $strAmount,
            $strServiceFee,
            $strNewBalance,
    ...
    public function buyLoadNotification(
        string $to,
        float $amount,
        string $productName,
        ...
        $template = new BuyLoadSenderNotification(
            $strAmount,
            $productName,
