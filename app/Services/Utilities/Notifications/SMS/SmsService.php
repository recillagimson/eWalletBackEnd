...
class SmsService implements ISmsService
{
    ...
    public function sendBPICashInNotification(string $to, UserDetail $userDetail, $newBalance, string $referenceNumber)
    {
        ...
        $content = "Hi " . $userDetail->first_name . "! You have successfully added funds to your wallet via BPI on " . $date . ". Service fee for this transaction is P0.00. Your new balance is P" . $newBalance . " with reference no. " . $referenceNumber . ". Thank you for using SquidPay!";
        $this->sendMessages($to, $content);
    }
